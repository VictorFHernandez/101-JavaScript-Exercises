...
function isPositiveOdd(number) {
  return Math.abs(number % 2) === 1 && number > 0;
...
function countNegatives(sequence){
    var countsNegatives = 0;
    for(var i = 0; i < sequence.length; i++){
        if(sequence[i] < 0){
            countsNegatives++
        }
    }
    return countsNegatives;
}
...
function onlyPositiveOdds(sequence){
    var positiveOdds = [];
    for(var i = 0; i < sequence.length; i++){
        if(sequence[i] >= 0 && sequence[i] % 2 === 1){
            positiveOdds.push(sequence[i])
        }
    }
    return positiveOdds;
}
